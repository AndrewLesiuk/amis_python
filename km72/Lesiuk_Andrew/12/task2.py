...
def recmaxx(n, maxx, k, iterator1):
    n1 = n.split(" ")
    if iterator1 <= len(n1)-1:
        if int(n1[iterator1]) > int(maxx):
            maxx = n1[iterator1]
            k = 1
            return(recmaxx(n, maxx, k, iterator1+1))
        elif int(n1[iterator1]) == int(maxx):
            k = k+1
            return(recmaxx(n, maxx, k, iterator1+1))
        else:
            return(recmaxx(n, maxx, k, iterator1+1))
        ...
        return(k)
print("Програма знаходить кількість максимальних елементів")
k = 0
vvid1 = 0
n = 0
iterator = 0
...
n1 = n.split(" ")
maxx = n1[iterator1]
print("Кількість максимальних елементів =", recmaxx(n, maxx, k, iterator1))
